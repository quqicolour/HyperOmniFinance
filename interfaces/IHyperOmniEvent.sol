...
interface IHyperOmniEvent{
    ...
    event LendCrossUSDC(address indexed receiver,uint32 indexed destinationDomain,uint256 amount);

    event CrossUSDC(address indexed _sender,address indexed _receiver,uint256 amount);
