...
contract HyperStablePair is IHyperStablePair, HyperStableERC20 {
    ...
    function mint(address to) external lock returns (uint liquidity) {
        ...
        uint balance0 = getTokenBalance(token0, address(this));
        uint balance1 = getTokenBalance(token1, address(this));
    ...
    function burn(
        ...
        uint balance0 = getTokenBalance(_token0, address(this));
        uint balance1 = getTokenBalance(_token1, address(this));
        ...
        balance0 = getTokenBalance(_token0, address(this));
        balance1 = getTokenBalance(_token1, address(this));
    ...
    function skim(address to) external lock {
        ...
        _safeTransfer(
            _token0,
            to,
            getTokenBalance(_token0, address(this)) - reserve0
        );
        _safeTransfer(
            _token1,
            to,
            getTokenBalance(_token1, address(this)) - reserve1
        );
    }
    ...
    function sync() external lock {
        _update(
            getTokenBalance(token0, address(this)),
            getTokenBalance(token1, address(this)),
            reserve0,
            reserve1
        );
    }
